...
const SignUpForm = () => {
  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const errorMessage = results.find(({ message }) => message !== MESSAGE.SUCCESS.RESPONSE);
    if (errorMessage) {
      alert(errorMessage);
      return;
    }
    ...
    <S.SignUpForm onSubmit={handleSignUp}>
      ...
      <S.InputWrapper>
        <Input
          ...
          required={true}
          error={userInfo.email && emailErrorMessage ? true : false}
        />
      ...
      <S.InputWrapper>
        <Input
          ...
          name='age'
          onChange={handleChange}
          error={userInfo.age && ageErrorMessage ? true : false}
        />
      ...
      <S.InputWrapper>
        <Input
          ...
          onChange={handleChange}
          required={true}
          error={userInfo.password && passwordErrorMessage ? true : false}
        />
      ...
      <S.InputWrapper>
        <Input
          ...
          onChange={handleChange}
          required={true}
          error={userInfo.confirmPassword && confirmPasswordErrorMessage ? true : false}
        />
