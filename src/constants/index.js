export const ROUTE = {
  HOME: { NAME: '홈', PATH: '/', ACCESS: 'none' },
  STATION_MANAGE: {
    NAME: '역 관리',
    PATH: '/station-mange',
    ACCESS: 'private',
  },
  LINE_MANAGE: { NAME: '노선 관리', PATH: '/line-manage', ACCESS: 'private' },
  SECTION_MANAGE: {
    NAME: '구간 관리',
    PATH: '/section-manage',
    ACCESS: 'private',
  },
  MAP: { NAME: '전체 보기', PATH: '/map', ACCESS: 'all' },
  SIGN_IN: { NAME: '로그인', PATH: '/sign-in', ACCESS: 'public' },
  SIGN_OUT: { NAME: '로그아웃', PATH: '/sign-out', ACCESS: 'private' },
  SIGN_UP: { NAME: '회원가입', PATH: '/sign-up', ACCESS: 'none' },
};
