...
<img width="100%" src="public/assets/gif/로그인.gif">
...
- [x] 사용자는 지하철 역 이름을 수정할 수 있다.

<img width="100%" src="public/assets/gif/역_관리.gif">
...
<img width="100%" src="public/assets/gif/노선_관리.gif">
...
<img width="100%" src="public/assets/gif/구간_관리.gif">

### 5. 지하철 전체 보기 기능

- [x] 사용자는 등록된 모든 노선과 역 정보를 확인할 수 있다.
  - [x] 환승역은 별도의 표시를 한다.
  - [x] 환승역에 마우스를 올리면 환승 노선에 대한 정보를 보여준다.

<img width="100%" src="public/assets/gif/전체보기.gif">
